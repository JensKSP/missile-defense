...
def exported(trained_run: Path, tmp_path_factory: pytest.TempPathFactory) -> Path:
    ...
    from missile_defense.sim import export_policy  # noqa: PLC0415 — optional dependency
...
def _python_actions(policy: Path) -> list[int]:
    ...
    from missile_defense.sim import eval as md_eval  # noqa: PLC0415 — optional dependency
    from missile_defense.sim import (  # noqa: PLC0415 — optional dependency
        export_policy,
        policy_format,
    )
