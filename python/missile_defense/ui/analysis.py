...
Everything numeric is computed in :mod:`missile_defense.ui.stats`, which has no Qt in it and
...
class StatTile(QFrame):
    ...
    *direction × whether up is good*, which the tile cannot work out for itself
    ...
    score never is). :data:`missile_defense.ui.stats.LOWER_IS_BETTER` holds that knowledge.
    """
