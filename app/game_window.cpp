...
/// Where the training loop writes its episodes, by the rule in `missile_defense/runs/paths.py`:
...
/// 1330` are two rows nobody can choose between. `missile_defense.runs.league` refuses a
